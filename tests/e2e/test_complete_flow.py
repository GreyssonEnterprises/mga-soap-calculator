...
async def test_complete_calculation_flow(client: AsyncClient, test_db):
    ...
    assert retrieved_calculation["recipe"]["lye"]["naoh_weight_g"] == calculation_result["recipe"]["lye"]["naoh_weight_g"]
    assert retrieved_calculation["recipe"]["water_weight_g"] == calculation_result["recipe"]["water_weight_g"]
