...
class EssentialOilRecommendationResponse(BaseModel):
    ...
    id: str
    common_name: str
    botanical_name: str | None = Field(None, description="Scientific name")
    ...
    scent_profile: str | None = Field(None, description="Scent characteristics")
    note: str | None = Field(None, description="Fragrance note: top, middle, or base")
    category: str | None = Field(None, description="Scent category")

    blends_with: list[str] | None = Field(None, description="Essential oils that blend well")

    warnings: str | None = Field(None, description="Safety warnings")
