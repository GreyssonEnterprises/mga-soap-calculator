"""
Seed data for oils and additives based on research and specification.

Oil data from Appendix B of spec.
Additive data from agent-os/research/soap-additive-effects.md
"""

# Oil seed data - 10+ common soap-making oils with complete profiles
OIL_SEED_DATA = [
    {
        "id": "olive_oil",
    ...
    },
    {
        ...
        "inci_name": "Elaeis Guineensis Oil",
        "sap_value_naoh": 0.141,
        "sap_value_koh": 0.198,
        "iodine_value": 53.0,
        "ins_value": 145.0,
        "fatty_acids": {
    ...
    },
    {
        "id": "lard",
        "common_name": "Lard",
        "inci_name": "Adeps Suillus",
        "sap_value_naoh": 0.138,
        "sap_value_koh": 0.194,
        "iodine_value": 60.0,
        "ins_value": 139.0,
        "fatty_acids": {
...
# Additive seed data - effects from research at 2% usage rate
ADDITIVE_SEED_DATA = [
    # High Confidence Additives
    {
        "id": "sodium_lactate",
    ...
    },
    {
        ...
        "confidence_level": "high",
        "verified_by_mga": False,
        "safety_warnings": {"heat": "Increases saponification heat - use cool temperatures"},
    },
    {
        "id": "honey",
        "common_name": "Honey",
    ...
    {
        "id": "sea_salt_brine",
        "common_name": "Sea Salt (Brine Method)",
    ...
    {
        "id": "silk",
        "common_name": "Silk (Tussah Fibers)",
        "inci_name": "Serica (Silk)",
        ...
        "verified_by_mga": False,
        "safety_warnings": {"usage": "Dissolve in hot lye water before adding lye crystals"},
    },
    {
        "id": "bentonite_clay",
    ...
    },
    {
        ...
        "common_name": "French Green Clay",
        "inci_name": "Illite/Montmorillonite",
        "typical_usage_min_percent": 1.0,
        "typical_usage_max_percent": 3.0,
        "quality_effects": {
            "hardness": 4.5,
        ...
        "confidence_level": "medium",
        "verified_by_mga": False,
        "safety_warnings": {"skin_type": "Detoxifying - best for oily/acne-prone skin"},
    },
    {
        "id": "rose_clay",
        "common_name": "Rose Clay (Pink Kaolin)",
        "inci_name": "Kaolin (with natural iron oxide)",
        "typical_usage_min_percent": 1.0,
        "typical_usage_max_percent": 3.0,
        "quality_effects": {
            "hardness": 3.0,
        ...
        "confidence_level": "medium",
        "verified_by_mga": False,
        "safety_warnings": {"skin_type": "Gentle - suitable for sensitive/dry/mature skin"},
    },
    {
        "id": "rhassoul_clay",
        "common_name": "Rhassoul Clay (Moroccan Red)",
        "inci_name": "Moroccan Lava Clay",
        "typical_usage_min_percent": 1.0,
        "typical_usage_max_percent": 3.0,
        "quality_effects": {
            "hardness": 3.8,
    ...
    {
        "id": "goat_milk_powder",
        "common_name": "Goat Milk Powder",
        "inci_name": "Caprae Lac (Goat Milk) Powder",
        "typical_usage_min_percent": 1.0,
        "typical_usage_max_percent": 3.0,
        "quality_effects": {
            "hardness": 1.0,
