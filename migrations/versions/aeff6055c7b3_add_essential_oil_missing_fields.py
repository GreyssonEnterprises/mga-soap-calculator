...
down_revision: Union[str, None] = 'd4e242f8056c'
...
def upgrade() -> None:
    ...
    op.add_column('essential_oils', sa.Column('usage_notes', sa.Text(), nullable=True, comment='Usage guidance and historical context'))
    op.add_column('essential_oils', sa.Column('color_effect', sa.String(length=200), nullable=True, comment='Expected color impact on soap'))

    # Change warnings from ARRAY to String
    op.alter_column('essential_oils', 'warnings',
